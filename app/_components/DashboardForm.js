  ...
  return (
    <form className="flex flex-col w-full items-center justify-around">
      ...
      <div className="flex flex-col gap-2 items-center w-4/5">
        <label className="text-md text-center" htmlFor="genre">
          Any specific genre preference?
        </label>
        <select className="p-2 w-4/5" name="genre" id="genre">
          <option value="">Not really!</option>
      ...
      <div className="flex flex-col gap-2 w-4/5 items-center">
        ...
        <input className="w-3/4" type="number" defaultValue={20}></input>
      </div>
